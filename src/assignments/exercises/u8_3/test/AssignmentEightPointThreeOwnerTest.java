package assignments.exercises.u8_3.test;// JUNIT: ägarklassens array av hundar U8.3. Detta test ersätter inte testen från AssignmentEightPointOneOwnerTest, utan kompletterar dem med test på den nya funktionaliteten


import assignments.exercises.u8_3.Dog;
import assignments. exercises.u8_3.DogList;
import assignments.exercises.u8_3.Owner;
...
public class AssignmentEightPointThreeOwnerTest extends ApiBaseTest {
 	...
 	private static final ClassUnderTest DOG_LIST_CLASS = new ClassUnderTest(DogList.class,
