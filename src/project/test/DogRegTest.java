...
public class DogRegTest extends IOBaseTest {

    private static final ClassUnderTest CUT = new ClassUnderTest(DogRegTest.class,
            "DogReg");
    ...
    private List<Dog> dogs(DogRegTest sut) {
